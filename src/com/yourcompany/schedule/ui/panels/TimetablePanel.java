...
public class TimetablePanel extends JPanel {
    ...
    private Map<com.yourcompany.schedule.model.Course, Color> courseColors = new HashMap<>();
    ...
    private void assignColors() {
        ...
        for (ScheduleEntry entry : entries) {
            com.yourcompany.schedule.model.Course c = entry.getOffering().getCourse();
    ...
    private void drawEntry(Graphics2D g2, ScheduleEntry entry, int slotWidth, int slotHeight, int minBlockHeight) {
        ...
        Color color = courseColors.getOrDefault(entry.getOffering().getCourse(), Color.LIGHT_GRAY);
        g2.setColor(color);
        ...
        // Course name
        com.yourcompany.schedule.model.Course course = entry.getOffering().getCourse();
        ...
        if (height >= minBlockHeight + lineHeight * 2) {
            ...
            if (height >= minBlockHeight + lineHeight * 3) {
                com.yourcompany.schedule.model.Teacher teacher = entry.getOffering().getTeacher();
                ...
                if (height >= minBlockHeight + lineHeight * 4) {
                    com.yourcompany.schedule.model.SchoolClass sc = entry.getOffering().getSchoolClass();
                    String className = sc != null ? sc.getName() : "";
    ...
    public String getToolTipText(java.awt.event.MouseEvent event) {
        ...
        for (ScheduleEntry entry : entries) {
            ...
            if (mx >= x+4 && mx <= x+SLOT_WIDTH-4 && my >= y+4 && my <= y+height-4) {
                ...
                String courseName = off != null && off.getCourse() != null ? off.getCourse().getCourseName() : "No Course";
                String roomName = entry.getRoom() != null ? entry.getRoom().getRoomName() : "No Room";
                String teacherName = off != null && off.getTeacher() != null ? off.getTeacher().getName() : "No Teacher";
                String className = off != null && off.getSchoolClass() != null ? off.getSchoolClass().getName() : "No Class";
